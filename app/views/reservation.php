...
if (Session::isValidCredentials()):?>
    ...
    <div id="wrapper">
        ...
        $percentage = $reservationController->getStatePercentage();
        ?>
                            ...
                            <div class="card mb-3">
                                <div class="card-body text-center shadow">
                                    ...
                                    <img class="rounded" data-bs-hover-animate="pulse" width="100%" height="100%"
                                         src="../../public/images/reservation.png" alt="">
                                </div>
                            </div>
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="text-primary font-weight-bold m-0">Estado de reservaciones</h6>
                                </div>
                                <div class="card-body">
                                    <h4 class="small font-weight-bold">Finalizadas<span class="float-right">
                                            <?= round($percentage[0], 2) ?>%</span>
                                    </h4>
                                    ...
                                    <h4 class="small font-weight-bold">En curso<span
                                ...
                                <div class="col">
                                    <div class="card shadow mb-3">
                                        <div class="card-body" style="text-align: center;">
                                            <h4 class="text-center card-title">Administrar Reservaciones</h4><img
                                                    class="rounded-circle img-fluid border rounded-pill shadow-sm"
                                                    data-bs-hover-animate="pulse"
                                                    src="../../public/images/adminReservation.png" width="50%"
                                                    height="50%" alt="Imagen no encontrada"
