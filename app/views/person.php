                            ...
                            <div class="card mb-3">
                                <div class="card-body text-center shadow">
                                    ...
                                    <img class="rounded" data-bs-hover-animate="pulse" width="100%" height="100%"
                                         src="../../public/images/person.png" alt="Imagen no encontrada">
                                </div>
                            </div>
                            <div class="col mb-4">
                                <div class="card shadow border-left-info py-2">
                                    <div class="card-body">
                                        <div class="row align-items-center no-gutters">
                                            ...
                                            <div class="col-auto"><span class="fas fa-address-card fa-2x text-gray-300"></span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col">
                                    <div class="card shadow mb-3">
                                        <div class="card-body" style="text-align: center;">
                                            <h4 class="text-center card-title">Administrar Personas</h4><img
                                                    class="rounded-circle img-fluid border rounded-pill shadow-sm"
                                                    data-bs-hover-animate="pulse"
                                                    src="../../public/images/adminPerson.png" width="50%"
